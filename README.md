...
SeleniumTestNG/
│
├── src/main/java/FirstClass/
│   ├── AlertHandle.java
│   ├── BatchDriverTest.java
│   ├── BrowserCommandsExample.java
│   ├── CopyAndPasteHandling.java
│   ├── LocatorsExample.java
│   ├── MouseHoverHandling.java
│   ├── NavigationCommandsExample.java
│   ├── ScrollHandling.java
│   ├── SelectMethodHandling.java
│   ├── TestNGExample.java
│   └── WebElementCommandsExample.java
│
├── testng.xml
├── pom.xml
└── README.md
...
🎓 CSE Student
💻 Aspiring SQA Engineer and also Lecturer
